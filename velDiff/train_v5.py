...
writer = SummaryWriter(log_dir=args['path_tensorlogs'])
...
SAVE_DIR = args['path_save_checkpoints']
...
def train():
    ...
    optimizer = torch.optim.AdamW(params, lr=args['train_params_optimizer_lr'], weight_decay=args['train_params_optimizer_weight_decay'])
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=args['train_params_optimizer_lr_schedule_step'], gamma=args['train_params_optimizer_lr_schedule_gamma'])
